...
@current_app.task(bind=True, name="index_paper")
def index_paper(self, arxiv_id: str):
    ...
    try:
        ...
        # Update progress
        self.update_state(state="PROCESSING", meta={"arxiv_id": arxiv_id, "progress": 0.3})
        ...
        # Update progress
        self.update_state(state="FINALIZING", meta={"arxiv_id": arxiv_id, "progress": 0.9})
        ...
        return {
            "status": "completed",
            "arxiv_id": arxiv_id,
            "title": paper.latex.title if hasattr(paper, "latex") and paper.latex else "Unknown",
            "progress": 1.0
        }
...
@current_app.task(bind=True, name="index_papers_batch")
